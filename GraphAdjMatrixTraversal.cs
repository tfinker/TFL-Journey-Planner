...
{
    class GraphAdjMatrixTraversal : GraphAdjMatrix
    {
      private bool[] visitedVertex;
      private List<int> orderTraversed;

      public GraphAdjMatrixTraversal(String graphName, int numberOfVertices)
        ...
        public GraphAdjMatrixTraversal(String graphName, int numberOfVertices, int[,] Edges)
